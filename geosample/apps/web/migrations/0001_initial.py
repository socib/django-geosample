...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'web_page', (
            ...
            ('introduction', self.gf('django.db.models.fields.CharField')(max_length=900)),
            ('parent', self.gf('mptt.fields.TreeForeignKey')(blank=True, related_name='children', null=True, to=orm['web.Page'])),
        ...
        # Adding M2M table for field related on 'Page'
        m2m_table_name = db.shorten_name(u'web_page_related')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('from_page', models.ForeignKey(orm[u'web.page'], null=False)),
            ('to_page', models.ForeignKey(orm[u'web.page'], null=False))
        ))
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field related on 'Page'
        db.delete_table(db.shorten_name(u'web_page_related'))
    ...
    models = {
        ...
        u'web.page': {
            ...
            'introduction': ('django.db.models.fields.CharField', [], {'max_length': '900'}),
