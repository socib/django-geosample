...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'web_page', 'introduction', self.gf('django.db.models.fields.CharField')(max_length=900, null=True))

    def backwards(self, orm):

        # Changing field 'Page.introduction'
        db.alter_column(u'web_page', 'introduction', self.gf('django.db.models.fields.CharField')(default=' ', max_length=900))
